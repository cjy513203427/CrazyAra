...
#ifdef TORCH
#ifndef SMALLANDLARGENN_H
#define SMALLANDLARGENN_H
 ...
 */
class SmallAndLargeNN : public NeuralNetAPI
{
private:
...
public:
    ...
    void predict(float *smallInputPlanes, float *largeInputPlanes, float *smallValueOutput, float *largeValueOutput, float *smallProbOutputs, float *largeProbOutputs, float *smallAuxiliaryOutputs, float *largeAuxiliaryOutputs) override;
